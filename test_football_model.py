...
# Allow loading older YOLO models with PyTorch 2.6+
# This is safe for trusted Hugging Face models
...
def test_football_model():
    ...
    print("\n🔄 Loading Hugging Face model: uisikdag/yolo-v8-football-players-detection")
    print("   Expected classes: ball, goalkeeper, player, referee")
    print("   Reported mAP@0.5: 0.785")

    try:
        model = YOLO('uisikdag/yolo-v8-football-players-detection')
